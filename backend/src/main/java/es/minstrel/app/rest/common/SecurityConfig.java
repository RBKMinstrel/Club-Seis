    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/admin/roles")).hasRole("Usuarios")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/admin/users")).hasRole("Usuarios")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/admin/users")).hasRole("Usuarios")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/admin/users/*")).hasRole("Usuarios")
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/admin/users/*")).hasRole("Usuarios")
                        .requestMatchers(antMatcher(HttpMethod.DELETE, "/api/admin/users/*")).hasRole("Usuarios")
                        /*Peticiones relativas a contabilidadService*/
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/conceptos")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/contabilidad/conceptos")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/contabilidad/conceptos/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/categorias")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/contabilidad/categorias")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/contabilidad/categorias/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/cuentas")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/contabilidad/cuentas")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/contabilidad/cuentas/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/razon-social")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/contabilidad/razon-social")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/contabilidad/razon-social/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/movimientos")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/contabilidad/movimientos")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/movimientos/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.PUT, "/api/contabilidad/movimientos/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.DELETE, "/api/contabilidad/movimientos/*")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/summary")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/contabilidad/descargar-excel")).hasRole("Financias")
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/contabilidad/subir-excel")).hasRole("Financias")
