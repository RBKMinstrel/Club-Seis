...
public interface CategoriaDao extends JpaRepository<Categoria, Long> {
    ...
    @Query("SELECT c FROM Categoria c WHERE LOWER(function('replace', c.name, 'á', 'a')) LIKE LOWER(function('replace', :name, 'á', 'a'))" +
    ...
    Optional<Categoria> getCategoriaByName(@Param("name") String name);
